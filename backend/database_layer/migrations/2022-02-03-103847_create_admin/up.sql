...
VALUES (1, 'admin', '-', 'admin', 'ER000000', '1970-01-01UTC', 'admin@starbet.live','+420000000000', '1970-01-01UTC', '0.0', NULL);


INSERT INTO "user_address"(user_id, street_name, street_number, city, area, postal_code, country, valid_from)
VALUES (1, 'Botanicka', '68a', 'Brno', NULL, '60200', 'Czech republic', '1970-01-01UTC');